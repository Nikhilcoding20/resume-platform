...
export const metadata = {
  title: 'Free AI Cover Letter Generator — Write in 60 Seconds | Unemployed Club',
  description:
    'Generate a professional, personalized cover letter in 60 seconds with AI. Tailored to the job description. Free to start — no credit card required.',
  alternates: {
    canonical: 'https://www.unemployedclub.com/cover-letter-generator',
  },
}
...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes, free to generate and preview. Download requires a free account.',
  },
  {
    q: 'How personalized is the cover letter?',
    a: 'Very. It uses your resume and the specific job description to write a tailored letter.',
  },
  {
    q: 'Can I edit the generated cover letter?',
    a: 'Yes, you can edit every word before downloading.',
  },
  {
    q: 'How long does it take?',
    a: 'Most users generate a complete cover letter in under 60 seconds.',
  },
  {
    q: 'What format is the download?',
    a: 'PDF format, ready to attach to any job application.',
  },
  {
    q: 'Does it work for Canadian job applications?',
    a: 'Yes, it works for job applications worldwide including Canada.',
  },
]
...
const STEPS = [
  {
    ...
    description: 'Upload your resume so AI knows your background.',
  },
  {
    num: '02',
    title: 'Paste the Job Description',
    description: 'Add the job posting and AI tailors the letter to it.',
  },
  {
    num: '03',
    title: 'Edit & Download',
    description: 'Edit the letter if needed and download as PDF.',
  },
]
...
const FEATURES = [
  {
    ...
    description: 'AI writes a personalized letter based on your resume and the job.',
  },
  {
    title: 'Job Description Matching',
    description: 'Letter is tailored to match keywords from the job posting.',
  },
  {
    title: 'Professional Tone',
    description: 'Sounds human, professional and compelling — not robotic.',
  },
  {
    title: 'Editable Output',
    description: 'Edit any part of the generated letter before downloading.',
  },
  {
    title: 'PDF Download',
    description: 'Download your cover letter as a polished PDF instantly.',
  },
  {
    title: 'Resume + Cover Letter Bundle',
    description: 'Build a matching resume and cover letter together.',
  },
]

const STATS = [
  { value: '25,000+', label: 'Cover Letters Generated' },
  { value: '60 Seconds', label: 'To Write' },
...
export default function CoverLetterGeneratorLandingPage() {
  return (
    <div className="min-h-screen bg-white text-[#1a1a2e]">
      ...
      <section className="relative overflow-hidden pt-14 pb-16 sm:pt-20 sm:pb-24 lg:pt-24 lg:pb-28">
        ...
        <div className="relative z-[1] mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h1 className="mb-6 text-[1.75rem] font-extrabold leading-[1.12] tracking-tight text-[#1a1a2e] sm:text-4xl lg:text-5xl">
            AI Cover Letter Generator — Write in 60 Seconds
          </h1>
          <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-[#5c5c7a] sm:text-lg">
            Paste the job description and let AI write a personalized cover letter. Edit, download as PDF, and apply.
          </p>
          <div className="mb-6 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            ...
            >
              Generate My Cover Letter <span aria-hidden>→</span>
            </Link>
            <Link
              href="/resume-builder"
          ...
          <p className="text-xs font-medium text-[#5c5c7a] sm:text-sm">
            <span className="text-[#6366f1]">✓</span> Free to start{' '}
            <span className="mx-2 text-[#eaeaf2]">·</span>
            <span className="text-[#6366f1]">✓</span> Personalized to job{' '}
            <span className="mx-2 text-[#eaeaf2]">·</span>
            <span className="text-[#6366f1]">✓</span> Download as PDF
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mb-12 max-w-xl text-center text-sm text-[#5c5c7a] sm:text-base">
            Three simple steps from job posting to a polished cover letter.
          </p>
      ...
      <section className="bg-[#f8f7ff] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-12 text-center text-2xl font-extrabold tracking-tight text-[#1a1a2e] sm:text-3xl lg:text-4xl">
            Everything You Need to Write the Perfect Cover Letter
          </h2>
      ...
      <section
        ...
        aria-labelledby="cover-letter-generator-faq-heading"
      >
        <div className="mx-auto max-w-3xl">
          <h2
            id="cover-letter-generator-faq-heading"
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-lg text-sm font-medium leading-relaxed text-white/95 drop-shadow-[0_1px_8px_rgba(15,23,42,0.25)] sm:text-base">
            Generate a professional, personalized cover letter tailored to any job description.
          </p>
          <Link
            href="/dashboard/cover-letter"
          ...
          >
            Generate My Cover Letter Free <span aria-hidden>→</span>
          </Link>
        </div>
      </section>
    </div>
