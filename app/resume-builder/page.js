...
export const metadata = {
  title: 'Free AI Resume Builder — Create ATS-Optimized Resumes | Unemployed Club',
  description:
    'Build a professional, ATS-optimized resume in minutes with AI. Choose from 4 templates, get your ATS score, and download as PDF. Free to start — no credit card required.',
  alternates: {
    canonical: 'https://www.unemployedclub.com/resume-builder',
  },
}
...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes, you can build and preview your resume for free. Download requires a free account.',
  },
  {
    q: 'How long does it take to build a resume?',
    a: 'Most users build a complete resume in under 10 minutes.',
  },
  {
    q: 'Is my resume ATS optimized?',
    a: 'Yes, every resume built on Unemployed Club is optimized to pass Applicant Tracking Systems.',
  },
  {
    q: 'What resume formats are available?',
    a: 'We offer 4 templates: ATS, Modern, Minimal, and Creative.',
  },
  {
    q: "Can I edit my resume after it's generated?",
    a: 'Yes, you can edit any section manually or use AI to improve specific parts.',
  },
  {
    q: 'Does it work for Canadian job applications?',
    a: 'Yes, Unemployed Club is built for job seekers in Canada and worldwide.',
  },
]
...
const STEPS = [
  {
    ...
    description:
      'Fill in your experience, skills and education in our simple form.',
  },
  {
    num: '02',
    title: 'AI Builds Your Resume',
    description:
      'Our AI writes professional bullet points and formats everything perfectly.',
  },
  {
    num: '03',
    title: 'Download & Apply',
    description:
      'Download your ATS-optimized resume as a PDF and start applying.',
  },
]
...
const FEATURES = [
  {
    ...
    description:
      'AI generates professional bullet points tailored to your experience.',
  },
  {
    title: 'ATS Optimized',
    description:
  ...
  },
  {
    ...
    description: 'Choose from ATS, Modern, Minimal, or Creative templates.',
  },
  {
    title: 'Instant PDF Download',
    description: 'Download your resume as a polished PDF instantly.',
  },
  {
    title: 'ATS Score Checker',
    description: 'See exactly how your resume scores before you apply.',
  },
  {
    title: 'Cover Letter Generator',
    description: 'Generate a matching cover letter in one click.',
  },
]

const STATS = [
  { value: '10,000+', label: 'Resumes Built' },
  { value: '4', label: 'Professional Templates' },
  { value: 'Free', label: 'ATS Checker Included' },
]
  ...
  return (
    <div className="min-h-screen bg-white text-[#1a1a2e]">
      ...
      <section className="relative overflow-hidden pt-14 pb-16 sm:pt-20 sm:pb-24 lg:pt-24 lg:pb-28">
        ...
        <div className="relative z-[1] mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h1 className="mb-6 text-[1.75rem] font-extrabold leading-[1.12] tracking-tight text-[#1a1a2e] sm:text-4xl lg:text-5xl">
            Free AI Resume Builder That Gets You Hired
          </h1>
          <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-[#5c5c7a] sm:text-lg">
            Build an ATS-optimized resume in minutes. AI writes it, you customize it, download as PDF.
          </p>
          <div className="mb-6 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            ...
            >
              Build My Resume Free <span aria-hidden>→</span>
            </Link>
            <Link
          ...
          <p className="text-xs font-medium text-[#5c5c7a] sm:text-sm">
            ...
            <span className="text-[#6366f1]">✓</span> No credit card{' '}
            <span className="mx-2 text-[#eaeaf2]">·</span>
            <span className="text-[#6366f1]">✓</span> ATS optimized
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mb-12 max-w-xl text-center text-sm text-[#5c5c7a] sm:text-base">
            Three simple steps from blank page to interview-ready resume.
          </p>
      ...
      <section
        ...
        aria-labelledby="resume-builder-faq-heading"
      >
        <div className="mx-auto max-w-3xl">
          <h2
            id="resume-builder-faq-heading"
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-lg text-sm font-medium leading-relaxed text-white/95 drop-shadow-[0_1px_8px_rgba(15,23,42,0.25)] sm:text-base">
            Join thousands of job seekers getting more interviews with AI-powered resumes.
          </p>
          <Link
            href="/dashboard/start"
