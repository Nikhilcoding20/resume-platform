            ...
            <div className="grid flex-1 grid-cols-1 gap-10 min-[420px]:grid-cols-2 sm:gap-8 lg:max-w-3xl lg:grid-cols-3 lg:gap-14">
              ...
              <div className="min-[420px]:col-span-2 lg:col-span-1">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <SocialIconButton
                    href="https://www.facebook.com/profile.php?id=61589892391159"
                  ...
                  <SocialIconButton href="https://www.instagram.com/unemployedclub_co/" label="Unemployed Club on Instagram">
                    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
