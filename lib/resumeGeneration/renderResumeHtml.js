...
export const ATS_PDF_MARGIN_IN = '0.5in'
const ATS_BODY_PT = 10
const ATS_BULLET_LINE_HEIGHT = 1.35
const ATS_SECTION_SPACING = '11pt'
const ATS_JOB_BLOCK_SPACING = '7pt'
...
function formatExperienceAts(experience, fitAdjustments = null) {
  ...
  return experience
    .map((job) => {
      ...
      return `<div class="experience-item resume-section" style="margin-bottom:${ATS_JOB_BLOCK_SPACING};page-break-inside:avoid;font-family:Georgia,Garamond,serif;">
...
export function getPdfStyles(template = '') {
  ...
  body.tpl-ats .ats-bullet-row { display: flex !important; align-items: flex-start !important; margin-bottom: 1.5pt !important; padding-left: 0.15in !important; font-size: 10pt !important; line-height: ${ATS_BULLET_LINE_HEIGHT} !important; }
