...
function formatBulletsAts(bullets, fitAdjustments = null) {
  ...
  const items = flattenAndDedupeBullets(bullets)
    .map(
      (b) =>
        `<div class="ats-bullet-row" style="display:flex;align-items:flex-start;gap:0.35em;margin:0 0 3pt 0;padding-left:0.25in;line-height:${lh};font-size:${bodyPt}pt;">
          <span class="ats-bullet-marker" style="flex-shrink:0;width:0.35em;text-align:center;">&#8226;</span>
...
export function getPdfStyles(template = '') {
  ...
  body.tpl-ats h1 { font-size: 17pt; font-weight: bold; }
  body.tpl-ats .resume-bullets.ats-bullets { margin: 2pt 0 0 0 !important; }
  body.tpl-ats .ats-bullet-row { display: flex !important; align-items: flex-start !important; }
