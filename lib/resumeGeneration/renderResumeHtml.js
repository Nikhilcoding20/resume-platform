...
function estimateContentLines(document, template = '') {
  ...
  const bulletFactor = t === 'ats' ? 1.05 : 1.2
...
/** Progressive ATS skills trim: 4 → 3 per category → drop last category. */
...
export function fitContentForTemplate(document, template) {
  ...
  if (t === 'ats') fitAtsSkillsToBudget(doc, limit)
...
function sectionHeading(title, template) {
  ...
  if (t === 'ats') {
    ...
    return `<h2 class="resume-section-heading ats-heading" style="margin:8pt 0 0 0;font-size:11pt;font-weight:bold;text-transform:none;letter-spacing:0;color:#000;line-height:1.3;">${escapeHtml(displayTitle)}</h2><hr class="ats-section-rule" style="border:none;border-top:0.5pt solid #000;margin:0 0 4pt 0;width:100%;height:0;" />`
  }
...
function formatExperienceAts(experience, fitAdjustments = null) {
  ...
  return experience
    .map((job) => {
      ...
      return `<div class="experience-item resume-section" style="margin-bottom:5pt;page-break-inside:avoid;font-family:Georgia,Garamond,serif;">
...
export function getPdfStyles(template = '') {
  ...
  body.tpl-ats .resume-header { text-align: center !important; margin-bottom: 6pt !important; }
  ...
  body.tpl-ats .resume-section-block { margin-bottom: 8pt !important; }
  body.tpl-ats .ats-section-rule { border: none !important; border-top: 0.5pt solid #000 !important; margin: 0 0 4pt 0 !important; }
  body.tpl-ats .experience-item { margin-bottom: 5pt !important; }
  body.tpl-ats .resume-bullets.ats-bullets { margin: 2pt 0 0 0 !important; }
  body.tpl-ats .ats-bullet-row { display: flex !important; align-items: flex-start !important; margin-bottom: 1.5pt !important; padding-left: 0.15in !important; font-size: 10pt !important; }
