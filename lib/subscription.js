...
export async function getActiveStripeSubscriptionPlan(supabase, userId) {
  ...
  // Accept active pro plans even when current_period_end is missing.
  // If a period end exists, use it as an additional safety validation.
  if (sub.current_period_end != null && sub.current_period_end !== '') {
